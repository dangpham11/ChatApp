    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ConversationBlock", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ConversationBlock_Users_BlockedUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NicknameUser1 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NicknameUser2 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    User1Muted = table.Column<bool>(type: "bit", nullable: false),
                    User2Muted = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VoiceDuration = table.Column<double>(type: "float", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ConversationBlock_BlockedUserId",
                table: "ConversationBlock",
                column: "BlockedUserId");

            migrationBuilder.CreateIndex(
                name: "IX_ConversationBlock_ConversationId",
                table: "ConversationBlock",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_ConversationBlock_Conversations_ConversationId",
                table: "ConversationBlock",
                column: "ConversationId",
                principalTable: "Conversations",
                principalColumn: "Id",
